...
namespace Numbers
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            {
                //This will be the output. Double type is not guaranteed to be accurate because some numbers literally cannot be represented as floating-point values. 0.1 does not exist in floating-point numbers. 
